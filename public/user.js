document.addEventListener("DOMContentLoaded", function () {
  ...
  joinButton.addEventListener("click", () => {
    ...
    if (classroomCode) {
      ...
      document.getElementById(
        "connectionStatus"
      ).textContent = `Attempting to join classroom with code: ${classroomCode}`;
  ...
  socket.on("joinedClassroom", (classroomCode) => {
    document.getElementById(
      "connectionStatus"
    ).textContent = `Successfully joined classroom with code: ${classroomCode}`;
    document.getElementById("connectionError").textContent = ""; // Clear any previous error
  });
  ...
  socket.on("joinError", (error) => {
    ...
    document.getElementById(
      "connectionError"
    ).textContent = `Failed to join classroom: ${error.message}`;
  });
